  ...
  return (
    <div className='bg1'>
      <nav className='flex justify-end p-4 space-x-4 md:space-x-16 bg-gray-800 fixed top-0 left-0 w-full'>
        <a href='#services' className='c1 font-mono'>Services</a>
        <a href='#contacts' className='c1'>Contacts</a>
        <a href='#about' className='c1'>About Us</a>
      </nav>
      ...
      <div className='text-center mt-10 border'>
        ...
        <div id='about' className='p-4'>
          ...
          <p className='mt-2'>At [Your Company Name], we are committed to redefining the property development landscape. Our team of experts combines passion with experience to deliver exceptional results in every project.</p>
        </div>
        ...
        <div className='p-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            <div className='p-4'>
              ...
              <p className='mt-2'>Designing and constructing state-of-the-art buildings that set new standards.</p>
            </div>
          </div>
        </div>

        <div className='grid grid-cols-2 lg:grid-cols-4 lg:px-96 md:grid-cols-4 justify-around mt-10 mr-6 p-4'>
          <div className='bg-blue-400 lg:h-80 p-5 rounded m-2 md:m-0 w-full md:w-auto flex flex-col items-center'>
